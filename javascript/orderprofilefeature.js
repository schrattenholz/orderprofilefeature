...
function checkUserActivity(){
	...
	jQuery.ajax({
		...
		if(parseInt(data)>0){
				//startActivitiyModal
				var message="Sie sind seit 10 Minuten inaktiv. Um Ihre Bestellung fortzusetzen, klicken Sie bitte auf \"Weiter bestellen\". Anderenfalls wird Ihr Warenkorb geleert.";
